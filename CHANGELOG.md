...
## [2.73.0](https://github.com/carscanbe/emailengine/compare/v2.72.1...v2.73.0) (2026-06-23)


### Features

* accept threadId on the submit reference object ([b1b3dc7](https://github.com/carscanbe/emailengine/commit/b1b3dc73ec5870a7a8ab9f0844055822ad046d2a))
* add AES-256-GCM encryption at rest for export files ([4f67269](https://github.com/carscanbe/emailengine/commit/4f6726915bd40087c0f447a7f2cb36943e8a849a))
* add anonymized feature beacon to license validation ([954d92a](https://github.com/carscanbe/emailengine/commit/954d92a9d8e7c5fff6f1b8c711dfd228f556387a))
* add audit logging for admin authentication events ([0ea15d4](https://github.com/carscanbe/emailengine/commit/0ea15d444ed589cd872b11190d07f7751f5cf54b))
* Add bounce message classification using ML model ([e337ceb](https://github.com/carscanbe/emailengine/commit/e337cebfb813192c385687c510c9e189d3eb0854))
* Add check-bounce CLI command for analyzing bounce emails ([ae3a85d](https://github.com/carscanbe/emailengine/commit/ae3a85dd5acdf9c893196284487e536ac3d6d9ec))
* add configurable batch sizes for Gmail/Outlook exports ([a4d178c](https://github.com/carscanbe/emailengine/commit/a4d178ceee195825d7f05a263897a873c361b296))
* add configurable Gmail Pub/Sub subscription TTL setting ([ca33e7f](https://github.com/carscanbe/emailengine/commit/ca33e7f9101b3375d7e0001cdbe1d7a41a9442d3))
* Add dedicated page to view accounts assigned to IMAP worker threads ([6d7e69e](https://github.com/carscanbe/emailengine/commit/6d7e69e35230a3a11076d65174ef1ed7e0ecc144))
* add direct account registration for email service account apps ([6602b2e](https://github.com/carscanbe/emailengine/commit/6602b2ee3f851bcfec00b34e70756007763f5490))
* Add Exim-style bounce detection for diagnostic messages ([b82e588](https://github.com/carscanbe/emailengine/commit/b82e588d3e699f3c757c6a01f3fb9933c94bbb4c))
* add export beta notice and status indicator in UI ([271bd18](https://github.com/carscanbe/emailengine/commit/271bd1899241903c50f582827e0f08306c79cb1d))
* add export reliability improvements and resume capability ([9f78644](https://github.com/carscanbe/emailengine/commit/9f78644cc1801bf64725bbde47c0910aab69769b))
* add export UI to admin account page ([cf3ce49](https://github.com/carscanbe/emailengine/commit/cf3ce4979b6a4547081c2bea534a7327ebe73009))
* add global concurrent export limit and performance optimizations ([20a1272](https://github.com/carscanbe/emailengine/commit/20a1272ca20ee9961c5163a0c5d8c5452cb6b556))
* add Gmail Subscriptions tab to OAuth config page ([3bd30bf](https://github.com/carscanbe/emailengine/commit/3bd30bf0bbc26600eae40d42e95ef7976257e4f2))
* add include attachments option to export UI ([2b8d2c6](https://github.com/carscanbe/emailengine/commit/2b8d2c6cd60eb72556a1f1a4db03abf0cdc14e6f))
* add label/category filtering to message search ([c171c4e](https://github.com/carscanbe/emailengine/commit/c171c4e1efe582f7e532b69108110a1c48aa3ede))
* Add MS Graph webhook subscription state metrics ([3e3ad18](https://github.com/carscanbe/emailengine/commit/3e3ad184d013770d6defbe71f21072969fe105be))
* Add OAuth2 API metrics for MS Graph and Gmail backends ([9a8182c](https://github.com/carscanbe/emailengine/commit/9a8182cf82c1493e472573b97dded8660feaff7f))
* add OAuth2 app "Verify setup" diagnostic ([cba9f58](https://github.com/carscanbe/emailengine/commit/cba9f58bc58a434c6156cd2e55fee655336a4cf4))
* Add OAuth2 token refresh metrics to all refresh paths ([4c23c90](https://github.com/carscanbe/emailengine/commit/4c23c903edf916367ffc3bcd1b1abe97cf783bc6))
* add Outlook Service (client_credentials) provider for app-only Microsoft 365 access ([#587](https://github.com/carscanbe/emailengine/issues/587)) ([5f906cd](https://github.com/carscanbe/emailengine/commit/5f906cd540564afe2dc2024b4e17c2d5d9483ed2))
* add parallel message fetching for Gmail/Outlook export ([12de963](https://github.com/carscanbe/emailengine/commit/12de963abe8f6922a8840e8291e57a5dcf03e584))
* add passkey (WebAuthn) authentication for admin login ([a39b362](https://github.com/carscanbe/emailengine/commit/a39b362152597bcc864307cd7c46cdc78a3808e6))
* Add Prometheus metrics and Grafana dashboard ([e3d4088](https://github.com/carscanbe/emailengine/commit/e3d4088751ab0d04ea86425bbcea02ca49afbc90))
* add Workload Identity Federation for Gmail service accounts ([1879c5a](https://github.com/carscanbe/emailengine/commit/1879c5aaf30ccff1879e74d28b0c76e25b3d77ae))
* adopt pre-existing Gmail Pub/Sub resources with ownership tracking ([fe43fad](https://github.com/carscanbe/emailengine/commit/fe43fadad624025a56139382428256eb810f9e08))
* allow enabling Sentry error reporting from the admin UI ([a4076a4](https://github.com/carscanbe/emailengine/commit/a4076a4fa6658ccc998f9bfe35dddf015cd12b09))
* always use persistent sessions and support remember-me for passkey login ([6a6fc74](https://github.com/carscanbe/emailengine/commit/6a6fc74748f92372e135e88478a9fa0f83cf690f))
* detect unsafe Redis eviction config in dashboard warnings ([712d5d6](https://github.com/carscanbe/emailengine/commit/712d5d69b99cc45c6f3e123a084ef054236e0110))
* disable deprecated Document Store by default behind a feature gate ([8790f75](https://github.com/carscanbe/emailengine/commit/8790f7538ba2ee8d6ec73d1f3bbc221c2f54f0fe))
* display export expiration date in UI ([5e1e633](https://github.com/carscanbe/emailengine/commit/5e1e6334e13b3b1ff012bfd76b933548c6cb6d83))
* expose outlookSubscription in account info API ([0d97b51](https://github.com/carscanbe/emailengine/commit/0d97b51bd60458ad7a8cdd9170aa50605fd1c127))
* flag nested message/rfc822 attachments with encodedInMessage property ([7e51024](https://github.com/carscanbe/emailengine/commit/7e51024c690235e36cbbf8297939f0a41002b05e))
* handle MS Graph 'missed' lifecycle event for Outlook notification recovery ([d55f48c](https://github.com/carscanbe/emailengine/commit/d55f48c9a183f9e0108801563b1085c176dbeb06))
* Improve ARF complaint detection and add comprehensive tests ([5533552](https://github.com/carscanbe/emailengine/commit/55335526a19c6948675d126d1dbb14db353253a0))
* Improve autoreply detection and add comprehensive tests ([1cf179f](https://github.com/carscanbe/emailengine/commit/1cf179f8289eb05e8add420fe02d6410f61718cc))
* Improve bounce detection coverage for non-standard formats ([5393872](https://github.com/carscanbe/emailengine/commit/53938724c699b32177ece83c3d88be9a5432c067))
* Improve bounce detection for legacy formats ([90a0289](https://github.com/carscanbe/emailengine/commit/90a0289f7999e23149e14ff6ea5d703de056d5b0))
* lock Gmail auth method display after app creation ([6ba16c2](https://github.com/carscanbe/emailengine/commit/6ba16c2fbca571d500b21be776dbf5eb76fcf8a1))
* rebuild lost IMAP sync state without replaying messageNew ([9fe391e](https://github.com/carscanbe/emailengine/commit/9fe391e9d6350485aded780709305d698a4c65fb))
* replace Bugsnag with self-hosted Sentry for error tracking ([62de831](https://github.com/carscanbe/emailengine/commit/62de831a2911da9b649fe693547ba09d70e2e481))
* Replace static help.txt with dynamic CLI help system ([4cd5fb0](https://github.com/carscanbe/emailengine/commit/4cd5fb059c2bf7436c4262a7daee1e85f535c322))
* revoke upstream OAuth2 grant on account delete via ?revoke=true ([2a8c8fa](https://github.com/carscanbe/emailengine/commit/2a8c8faf7f63acfab31998fb067289d4c6bd2f09))
* revoke upstream OAuth2 grant on account delete via ?revoke=true ([15bc43a](https://github.com/carscanbe/emailengine/commit/15bc43ae0f8dbf70021a1e13de55c80ec7271a15))
* show curl example for service account OAuth2 apps ([4ab5eda](https://github.com/carscanbe/emailengine/commit/4ab5edabf64373e8b2dd4bb0ea658847d40ba904))
* show human-readable missing scopes on OAuth scope error page ([4ee2365](https://github.com/carscanbe/emailengine/commit/4ee2365449e3cbece6f4a83d540ae63c18464535))
* surface token hash for identification in API, UI, and logs ([8e2a5a9](https://github.com/carscanbe/emailengine/commit/8e2a5a9f2bb5194e92575c34c0006a8c4e21888d))
* tag Sentry error reports with instance id and license key ([2e9683f](https://github.com/carscanbe/emailengine/commit/2e9683f27d54ff8fa7ba3f6f4453866fd135f173))
* use tabs for Gmail auth method and lock it after creation ([6c74521](https://github.com/carscanbe/emailengine/commit/6c7452138c257ecf0667aa9b44d1fa91186e2302))


### Bug Fixes

* accept base64-encoded nonces for backward compatibility ([2c46822](https://github.com/carscanbe/emailengine/commit/2c46822a46ce1b2dc632f9a20f5831eabad3b623))
* add .catch() to fire-and-forget setMeta and track error fingerprints ([672a03e](https://github.com/carscanbe/emailengine/commit/672a03e2524bcaa26c4d3c908fa828f4e636999b))
* add BullMQ stalled job configuration to prevent queue hangs ([23a74c3](https://github.com/carscanbe/emailengine/commit/23a74c359e131baafd12dcf08d213eac0d96840f))
* Add EENGINE_DISABLE_SETUP_WARNINGS environment variable ([933a4f7](https://github.com/carscanbe/emailengine/commit/933a4f7c8935f1aeadab5b65c6454460e6e191d5))
* Add EENGINE_ENABLE_OAUTH_TOKENS_API environment variable support ([be74bf9](https://github.com/carscanbe/emailengine/commit/be74bf9b92ea20b9f0cbb7cf336036e4c2e5cf7b))
* Add environment variable support and deprecate unused OAuth2 fields ([a63fa8b](https://github.com/carscanbe/emailengine/commit/a63fa8b93073b325422d7ed4ea034e4d53ad2b2b))
* add error logging for MS Graph subscription creation failures ([ba928e4](https://github.com/carscanbe/emailengine/commit/ba928e495acb7fcc8c18e6cf34c917a2f4ad3337))
* add forced exit to prevent test timeout in CI ([aeb7261](https://github.com/carscanbe/emailengine/commit/aeb726169b26e7263acb55041112f5a97a818b8a))
* add IMAP fetch retry timeout and harden passkey registration ([3a1b61b](https://github.com/carscanbe/emailengine/commit/3a1b61b00e916c308cae5e7493a2207164d9d45f))
* add labels to remaining Joi schemas for stable OpenAPI names ([4e7e064](https://github.com/carscanbe/emailengine/commit/4e7e064063f9e882ec94ada9d0dd1aad6567c675))
* add lock to del() to prevent race with ensurePubsub, fix pubSubApp cleanup ([27f2bdd](https://github.com/carscanbe/emailengine/commit/27f2bdd4a9e3d7e913e7f4bed96084a278bb6312))
* add null guards to prevent unhandled exceptions ([9f48f64](https://github.com/carscanbe/emailengine/commit/9f48f64b4ded00afa819d06d85be469ef4ea3ab6))
* address 14 bugs found since v2.61.5 ([839ce55](https://github.com/carscanbe/emailengine/commit/839ce55502d28a23f86868012a51bd0077b31f65))
* address 5 release blockers for export and account APIs ([762c201](https://github.com/carscanbe/emailengine/commit/762c20112e9b4de705f037659702eca18b750092))
* address 6 critical/high bugs and make export limits opt-in ([eb14c69](https://github.com/carscanbe/emailengine/commit/eb14c69db2fad7c6fe8fd140de24c41f26922f48))
* address critical, high, and medium export feature issues ([576345a](https://github.com/carscanbe/emailengine/commit/576345ad82d30193a13eea1ea130bf711cfae483))
* address must-fix and should-fix issues for release ([6def6ef](https://github.com/carscanbe/emailengine/commit/6def6efc809e204fc39bd1bf6181a477fae0481f))
* address verified warnings from release review ([bb08f54](https://github.com/carscanbe/emailengine/commit/bb08f54c2aba248e4204b704a6730c8bdf1eeb0e))
* **AI:** Add GPT-5 support with updated token limits ([f99947a](https://github.com/carscanbe/emailengine/commit/f99947a34ff25ad0224c1b8e828d7cf104fd26a5))
* align API response schemas with actual responses and fix uncovered API bugs ([abacbf6](https://github.com/carscanbe/emailengine/commit/abacbf66f048a77d00d180a831a97594380d8ed9))
* align remaining API response schemas with actual responses ([06136ab](https://github.com/carscanbe/emailengine/commit/06136abd20a97c45b25aac7f93653387eb55928a))
* always notify webhook workers when Pub/Sub app config changes ([e9f276a](https://github.com/carscanbe/emailengine/commit/e9f276ab528ad384bcbf5c370a0d0cb22e084cc5))
* assign unassigned accounts after license activation ([5677977](https://github.com/carscanbe/emailengine/commit/56779778eba27f2d1604ff06f17e5736a5ddee61))
* auto-recover expired Gmail Pub/Sub subscriptions and expose status via API ([7961ceb](https://github.com/carscanbe/emailengine/commit/7961ceb8ce81688e5c3bb435a6c33ed3882afd7b))
* avoid 500 on GET /admin/totp without a partial-auth session ([b6f2394](https://github.com/carscanbe/emailengine/commit/b6f2394182379d94a05f95c84f5ce04ae6f87a05))
* avoid redundant Redis call and concurrent backfill races in Pub/Sub setup ([05b02af](https://github.com/carscanbe/emailengine/commit/05b02afc1c14de1b8fa4e272d26da2056280731a))
* bound inbound line length in the IMAP proxy parser ([9fb8a5e](https://github.com/carscanbe/emailengine/commit/9fb8a5e301564dee46b48ca32a5b84e4832d96e8))
* broaden Pub/Sub notification condition in oauth-routes.js ([cbe1380](https://github.com/carscanbe/emailengine/commit/cbe13800ab9460c41f5dcdcd4d7ae50f8e5e75e3))
* broken Handlebars script tag, Okta session fall-through, login rate limiting, and passkey schema validation ([01e5721](https://github.com/carscanbe/emailengine/commit/01e5721ee02ad66ce9c30b58c406988b1cfd1ae3))
* Bumped dependencies to get rid of security warnings ([54b13c4](https://github.com/carscanbe/emailengine/commit/54b13c4c4a42c7af886c63a97b6cdbb4dc8696b1))
* clean up Pub/Sub Redis keys on deletion, refresh stale instances, and localize UI labels ([3b35fa1](https://github.com/carscanbe/emailengine/commit/3b35fa19a6a8024a60d2ed21e9fcd69fda349481))
* clear passkey credentials on CLI password reset and document remember-me behavior ([35f7f00](https://github.com/carscanbe/emailengine/commit/35f7f00970b7e7f3a514d2ea0d97fce5320f6e1b))
* clear stale pubSubFlag after restart and consolidate backfill push ([f67961f](https://github.com/carscanbe/emailengine/commit/f67961fbc590aa586ef40b65c2189b5dab4d89c0))
* clearer error when loading wrong file into WIF config field ([40686d4](https://github.com/carscanbe/emailengine/commit/40686d409229347193c1e153e9e47f98b5de86dc))
* close command client proactively after subconnection setup ([02d3687](https://github.com/carscanbe/emailengine/commit/02d36874d8533beabe5ad0fba978851b3791cbb5))
* close leaks and a worker crash found in the connection hardening review ([e97950e](https://github.com/carscanbe/emailengine/commit/e97950e7e907ac5b5549302b8865c5d2bfb0d6e2))
* Correct API schema documentation and descriptions ([8a51465](https://github.com/carscanbe/emailengine/commit/8a514650c8422b666244164aa71fe1d7b6f0ec2b))
* Correct CPU usage chart unit from seconds to dimensionless ([88765bc](https://github.com/carscanbe/emailengine/commit/88765bc137a6dedafdaee8c6677b5e4e8ef2eec6))
* correct pubSubApp property name in del() and add cleanup tests ([016ae0a](https://github.com/carscanbe/emailengine/commit/016ae0a98bc52eeee2bd1ec4f4d0ed58e92c507d))
* correct translation errors and remove EmailEngine branding from OAuth scope error ([9284ddd](https://github.com/carscanbe/emailengine/commit/9284ddd1e28e40fd24abeea7296636b21c4b3878))
* correct typo in Pub/Sub schema version log message ([2cc8e08](https://github.com/carscanbe/emailengine/commit/2cc8e085463ed550e341b027e592b5351784182e))
* Correct y-positions of Redis panels in Grafana dashboard ([12fdeff](https://github.com/carscanbe/emailengine/commit/12fdeff1c4f837e7c37ebdb6c5647b01fb49c467))
* count undecodable export queue entries as skipped ([72e2498](https://github.com/carscanbe/emailengine/commit/72e2498390f17ad24d5f7b1577540674d7e1fe09))
* defer export worker job consumption until startup recovery completes ([a21b0a5](https://github.com/carscanbe/emailengine/commit/a21b0a50fdb98d13a2227a020069129d23fe225b))
* Detect "Out of the Office" autoreply subject pattern ([7191c50](https://github.com/carscanbe/emailengine/commit/7191c50ae62930a66bf6598cb55f94130e022cf9))
* detect IMAP drift that landed during an in-progress sync ([8fece8a](https://github.com/carscanbe/emailengine/commit/8fece8ad6f3acb5e7391da7a9740279099f62177))
* distinguish SO_REUSEPORT fallback cause in logs and admin UI ([99ad9f3](https://github.com/carscanbe/emailengine/commit/99ad9f3359eab5bafc4726535584874d4823f7bd))
* do not crash at startup when a feature flag env variable is set to a falsy value ([98ad979](https://github.com/carscanbe/emailengine/commit/98ad97988e752fad9e2ae11eff63f35ffcf84976))
* do not prefill login username field ([59835a8](https://github.com/carscanbe/emailengine/commit/59835a84f3e2a01c6461f29ecb80763dc4a42fe2))
* downgrade transient connection/timeout error logs to warn level ([9064529](https://github.com/carscanbe/emailengine/commit/9064529a0d21cd6198386c73d9abca3447f6dc31))
* downgrade transient PubSub poll errors from error to warn ([d9f2e2f](https://github.com/carscanbe/emailengine/commit/d9f2e2f6300b7e99a9ae57c6466fe147614bb891))
* drain webhook response body on every delivery path ([2cc3e7a](https://github.com/carscanbe/emailengine/commit/2cc3e7aef114b5b913dea5c363278e1a883d5a48))
* eliminate redundant Redis ops in Pub/Sub pull loop and backfill ([c8ebe39](https://github.com/carscanbe/emailengine/commit/c8ebe393744eee46c3d19b5be413badd8ab315d6))
* Enable NPM package publishing ([051f4d6](https://github.com/carscanbe/emailengine/commit/051f4d638ccea94f22d08924e300fa8672b51d9d))
* enrich OAuth token error messages for BullMQ job visibility ([29da53f](https://github.com/carscanbe/emailengine/commit/29da53ff38c12e59b54468f5be3579c758a651c0))
* Exclude browser-only deps from pkg bundle ([994dd41](https://github.com/carscanbe/emailengine/commit/994dd4169c5324d411feed804f277de119854916))
* extract gettext strings from the decomposed ui-routes modules ([227e60f](https://github.com/carscanbe/emailengine/commit/227e60ff4f354c5d0f55534877c8ab6fbdd92c7d))
* fail export when a folder cannot be indexed ([36c9c9d](https://github.com/carscanbe/emailengine/commit/36c9c9d536540cd5a61b16b69af5e8e84c194ee6))
* filter transient fetch failures from Sentry and retry DNS errors ([883b9b4](https://github.com/carscanbe/emailengine/commit/883b9b487e3580c5b1240d28cd519d190c402b47))
* fix export TTL expiration, cancellation cleanup, and expose truncated field ([019c05c](https://github.com/carscanbe/emailengine/commit/019c05c941842ae28668711e8f5c2e8a85d3b84b))
* fix lifecycle event races, lock TTL, and stale clearExisting in MS Graph subscriptions ([3f3cbac](https://github.com/carscanbe/emailengine/commit/3f3cbac843c4c221644492855d7c1beb41cd1da0))
* fix missing renewal retry, clock-skew gap, and incomplete pipeline error check ([8a8b5b6](https://github.com/carscanbe/emailengine/commit/8a8b5b68feb3edd7c984707a85ddb6d146739020))
* Fix OAuth2 token refresh metrics not being recorded ([a6bf696](https://github.com/carscanbe/emailengine/commit/a6bf6964e5b412bde5b44630eb20a3af59d2e700))
* fix off-by-one retry cap and simplify MS Graph subscription code ([aa9afbc](https://github.com/carscanbe/emailengine/commit/aa9afbc5aea20d1bf775e59dbfd82842c4f8b701))
* fix Pub/Sub deletion race, add 429 handling, batch ACKs, and lock ensurePubsub ([744c354](https://github.com/carscanbe/emailengine/commit/744c354a062f63eedcec8de1a324a5d13519b9a7))
* fix retry boundary, lock races, and dropped lifecycle events in MS Graph subscriptions ([d62741d](https://github.com/carscanbe/emailengine/commit/d62741d2a2aafc47d831482b71ff24fa4c9d1883))
* fix silent 401/403 error suppression, floating promise, and recovery loop in Pub/Sub ([406211c](https://github.com/carscanbe/emailengine/commit/406211cbd62f7d3f1b811fbec81767f319219c63))
* fix stale subscription state blocking recovery and retry count persisting across reconnects ([60b77d5](https://github.com/carscanbe/emailengine/commit/60b77d5d7574abf728c5e1f015c0cecddd5d9fdd))
* fix subscription loss on subscriptionRemoved, lifecycle webhook timeout, and retry gaps ([62988ab](https://github.com/carscanbe/emailengine/commit/62988ab3b690ed98583fa01557a9c4145427e3ae))
* flag WIF support in the gmailService form intro ([61fab27](https://github.com/carscanbe/emailengine/commit/61fab2720aa2f289a944ae99629bc47ada8e9e09))
* force Swagger UI to light mode only ([4c26d12](https://github.com/carscanbe/emailengine/commit/4c26d12437feaacd26da88a6fb3e85a7ca2ee238))
* force-exit external-account-signer test to unblock CI ([f4a1e4e](https://github.com/carscanbe/emailengine/commit/f4a1e4e50ac890d7771e38181a9488837c67757a))
* guard against null job in export worker BullMQ failed handler ([4cb1532](https://github.com/carscanbe/emailengine/commit/4cb15324b913b7a8fbcbf4f5714c26e3c06226b3))
* guard cross-thread download streams against early producer errors ([191ec62](https://github.com/carscanbe/emailengine/commit/191ec6204887c3abe78da7a9944e3165b19c0b87))
* guard fire-and-forget setMeta calls and add Pub/Sub graceful shutdown ([45f7b64](https://github.com/carscanbe/emailengine/commit/45f7b64d7692b220ff14ec0e1c0e9deea84731de))
* guard IMAP notification handlers against malformed events ([0248953](https://github.com/carscanbe/emailengine/commit/0248953a5dcccba5d46704bf7113a70fb5ac3150))
* guard null imapClient dereferences during async operations ([671bcee](https://github.com/carscanbe/emailengine/commit/671bcee4e81c7c0d6421617c3e25ec6906cb1abb))
* guard releaseLock against undefined, add 429 handling to Pub/Sub deletion ([d67ebe1](https://github.com/carscanbe/emailengine/commit/d67ebe138ca9663796eacc5a1c6b5b73e721e6c4))
* guard webhook notifications in BullMQ failure handlers ([e90048e](https://github.com/carscanbe/emailengine/commit/e90048e7b7bd92916219602f92305342234df4a3))
* handle delegation errors in loadAccountData, isApiClient, and UI listing ([c306618](https://github.com/carscanbe/emailengine/commit/c306618a37428bbf088ed1289bf832e778f14b9c))
* handle empty or invalid JSON responses from OAuth APIs ([57d8886](https://github.com/carscanbe/emailengine/commit/57d8886a0d29b20df4b575bac8210f6ed97f7fa3))
* handle missing attachments in ARF detection ([fe08f6a](https://github.com/carscanbe/emailengine/commit/fe08f6a8c3120a01e04860c5770f78e925678797))
* handle missing attachments in Outlook message conversion ([46cf25a](https://github.com/carscanbe/emailengine/commit/46cf25adefa9ca615f05381e257ee13a6c3e49b9))
* handle non-iterable messageInfo.attachments in mailbox sync ([3187571](https://github.com/carscanbe/emailengine/commit/31875714e0ceb8e8711c910f6c561e1b1fe81a50))
* handle non-numeric error codes from Microsoft Graph in OAuth callback ([#580](https://github.com/carscanbe/emailengine/issues/580)) ([89fd9f7](https://github.com/carscanbe/emailengine/commit/89fd9f74db0cb32d4980b57b6c623e5d98b426a8))
* handle notificationBaseUrl without trailing slash in prepareUrl ([1048818](https://github.com/carscanbe/emailengine/commit/1048818fe1b1a193a8d5f1b99a37285b54bd9317))
* handle TimeoutError from AbortSignal.timeout in Pub/Sub pull loop ([c0e3036](https://github.com/carscanbe/emailengine/commit/c0e303641e4eb9f6cdca3c584861052b2bd91148))
* handle uncaught EPIPE in ResponseStream for SSE endpoints ([ca7af4a](https://github.com/carscanbe/emailengine/commit/ca7af4ad7a4fa6ccc02dcaee79f06d33bd38e8b8))
* handle undici HeadersTimeoutError as transient in Pub/Sub and OAuth2 paths ([8b3b698](https://github.com/carscanbe/emailengine/commit/8b3b69880ab09119df4ca377d085db261eae2763))
* Harden bounce detection against edge cases and ReDoS attacks ([d6c72c2](https://github.com/carscanbe/emailengine/commit/d6c72c29d4c2bc1a20025204cc0cf20f803b04a6))
* harden IMAP proxy STARTTLS against command injection ([3661ddd](https://github.com/carscanbe/emailengine/commit/3661dddbf216b29ec8f074d3f6422dd4db5d9e7b))
* harden inter-thread IPC (worker-death call rejection, webhook guards, stream cleanup) ([0111a8e](https://github.com/carscanbe/emailengine/commit/0111a8e2bf139c3412cc37e5e933fd5316cee8fc))
* harden mergeObjects and tighten CodeQL scanning ([d35025d](https://github.com/carscanbe/emailengine/commit/d35025daabf8fe7b3f5200b0000f52c3a012f4eb))
* harden message export against data loss and corruption ([540d867](https://github.com/carscanbe/emailengine/commit/540d8678ec25f62e8123fc78fa929f4e4713b5d4))
* harden MS Graph subscription lifecycle, locking, cleanup, and error recovery ([8210056](https://github.com/carscanbe/emailengine/commit/8210056f7e7b00977fb5487323ff1b8f9f4b7a99))
* harden multiple-API-worker startup and centralize proxy-agent reload ([7f2db9e](https://github.com/carscanbe/emailengine/commit/7f2db9e557d960aa1b7523b7d8678598683c2f29))
* harden OAuth token request body serialization and error handling ([296c4e9](https://github.com/carscanbe/emailengine/commit/296c4e99fd00928fa0682f2c735c2d81c1a74bcf))
* harden passkey auth, IMAP sync error handling, and login form UX ([c16b983](https://github.com/carscanbe/emailengine/commit/c16b98312f35d87fd8b21974a7eb7eca6459cc3b))
* harden passkey authentication with validation, rate limits, and audit logging ([75dd289](https://github.com/carscanbe/emailengine/commit/75dd289940e7345fa56246c90ff6bc8d01694e6c))
* harden Pub/Sub deletion, IAM policy, and worker timeout cleanup ([0be7c3e](https://github.com/carscanbe/emailengine/commit/0be7c3eb04f3381306284e1e3790f7c3cc28cb5a))
* harden Pub/Sub pull loop resilience and fix projectId typo ([8124328](https://github.com/carscanbe/emailengine/commit/81243287f339b5fe40cddd0e1d127514d2e11f4a))
* harden Pub/Sub pull loop, message ACK, list pairing, and shutdown cleanup ([9e9775f](https://github.com/carscanbe/emailengine/commit/9e9775f6df97af42bdb8b799c2345a4564f8a77a))
* harden Pub/Sub pull loop, worker coordination, and OAuth app lifecycle ([529b705](https://github.com/carscanbe/emailengine/commit/529b7055dd4aeb0b1d80fabff3f139cf23f00252))
* harden Pub/Sub shutdown, loop scheduling, and abort lifecycle ([71b3ab4](https://github.com/carscanbe/emailengine/commit/71b3ab4625fa3304ae7a4413a3b0a64276948d7f))
* harden Pub/Sub shutdown, transient error handling, and input validation ([cfc6e0b](https://github.com/carscanbe/emailengine/commit/cfc6e0bb73902600b6eecc6bc955af85f06d9b0f))
* harden static file route with path confinement and pkg-only guard ([19cd5f6](https://github.com/carscanbe/emailengine/commit/19cd5f632baa7fb37f5d639f234c5374b371ab93))
* Improve auth-server example with proper error handling and documentation ([cef5b47](https://github.com/carscanbe/emailengine/commit/cef5b47378bdb18a1ff136fd29e8c63dd566cb86))
* improve BullMQ efficiency with jitter, retention, and cleanup ([fb48fd8](https://github.com/carscanbe/emailengine/commit/fb48fd84065fe44a4bf5054ced45f4bffc9c8153))
* Improve OAuth token refresh error handling and state management ([5be242b](https://github.com/carscanbe/emailengine/commit/5be242bd5392ff08f83d7709ad4f82f8f218e05d))
* improve packUid robustness with fallback and validation ([4b4253e](https://github.com/carscanbe/emailengine/commit/4b4253e3fd025070b42c3d012071dd6376191692))
* improve submit resilience during worker restarts and add batch endpoint ([f559c38](https://github.com/carscanbe/emailengine/commit/f559c3818bb727b137f5a2b8b32b0efee48a093d))
* improve translation quality across 6 languages ([d7d338e](https://github.com/carscanbe/emailengine/commit/d7d338e761152909d4c2ca4732fafb60529413ab))
* include ESM [@csstools](https://github.com/csstools) packages as pkg assets ([df9f6d2](https://github.com/carscanbe/emailengine/commit/df9f6d286b0fc2819edf0bf2f179dc0d6d2ce0d5))
* include failed jobs in /v1/outbox response ([b393676](https://github.com/carscanbe/emailengine/commit/b393676f2f877046d27b06d518a03dd256d5b7d9))
* Increase openAiPrompt max size from 6KB to 1MB ([29d673d](https://github.com/carscanbe/emailengine/commit/29d673d6bf35f78c3ef53ec1b690c49deecd889c))
* let npm run gettext parse object spread and drop non-ASCII from template ([195ce60](https://github.com/carscanbe/emailengine/commit/195ce601db50f394164ca05e2efb6de4b784a77a))
* leverage Nodemailer error codes for better retry logic and UI messages ([0f3068a](https://github.com/carscanbe/emailengine/commit/0f3068abc4b63d87a9f93ba927f8be07a5737f0c))
* list Outlook folders with slashes in the name ([dd35e7b](https://github.com/carscanbe/emailengine/commit/dd35e7b262a47f9395811d75c4bcc1d9ab4c6ec0))
* **LLM integration:** Add configurable max tokens setting for OpenAI API ([a746388](https://github.com/carscanbe/emailengine/commit/a746388c0b69746f21f6ac95e49d7797bb8f9722))
* localize error page strings using translation helper ([609ebb9](https://github.com/carscanbe/emailengine/commit/609ebb94d1e662ac661f7efe22f6608d7823fb85))
* log expected API client errors (4xx) at warn instead of error ([c51e347](https://github.com/carscanbe/emailengine/commit/c51e3476e346f321af845905a89141bf07a83421))
* login page divider logic, select() log level, and missing trailing newlines ([97ff93e](https://github.com/carscanbe/emailengine/commit/97ff93e2cc6c865a0f597a42a124e0abb140e34a))
* mask externalAccount in OAuth2 app API responses ([fac18bf](https://github.com/carscanbe/emailengine/commit/fac18bfdc11d5d252e0d93980aad7c90d92b246f))
* Memory leak fixes for IMAP client and webhooks worker ([b749f96](https://github.com/carscanbe/emailengine/commit/b749f964f7e8de6828d23b8c3c5a3ca11e15898a))
* move pubsub status from unauthenticated /health to GET /v1/pubsub/status ([f6597ad](https://github.com/carscanbe/emailengine/commit/f6597addff4de1c23fbd88964702bc2425f14d0c))
* normalize copy across login and security pages ([60e132a](https://github.com/carscanbe/emailengine/commit/60e132a9e4e8f96fc621b4b454f95896fb4d48c1))
* normalize sign-in/sign-out copy to sentence case ([1ccfb16](https://github.com/carscanbe/emailengine/commit/1ccfb167a674d887af0ac2db8df3ff434f23e5bb))
* only reseed lost IMAP sync state when no stored state exists ([78e0141](https://github.com/carscanbe/emailengine/commit/78e0141e9f3478d2a2a1206c805258c6807a45d8))
* per-IP passkey rate limiting and credential ownership check ([2455cbe](https://github.com/carscanbe/emailengine/commit/2455cbe9d6af5d6eff8ae81ecc335b6820bfc904))
* pin subdependency to avoid installing unsupported version ([045b8ce](https://github.com/carscanbe/emailengine/commit/045b8ce1a28c9cf9eecb26723589c5dcb4a28c21))
* pin undici to 7.25.0 for Node 20 compatibility ([3fa80db](https://github.com/carscanbe/emailengine/commit/3fa80db4d64d6fe089fa3a1a0e700a188aeb74f7))
* pkg config options must be a string array ([6c4702d](https://github.com/carscanbe/emailengine/commit/6c4702dbc85171a2987b8cfb6e5a3dc3d656a99d))
* prefer refresh token and skip gmailService when revoking on delete ([e0dbea8](https://github.com/carscanbe/emailengine/commit/e0dbea8a4cd4804bf64d50523c8a1152c2119e26))
* preserve threadId for large Gmail threaded replies via multipart upload ([b04c2ca](https://github.com/carscanbe/emailengine/commit/b04c2cac6bc7a6dfe347a800b57ed0bd1a21291a))
* prevent 500 error when listing accounts with invalid delegation config ([8651bcc](https://github.com/carscanbe/emailengine/commit/8651bcc3c18cd54ee5309b3392915773c355e6c4))
* prevent ArrayBuffer detachment and IMAP null reference errors ([3b97372](https://github.com/carscanbe/emailengine/commit/3b9737234b6f71ae9c1adbf4018134cc6bb4a070))
* prevent concurrent export race condition with atomic Redis operation ([dbc14f6](https://github.com/carscanbe/emailengine/commit/dbc14f683ef8509003699a12ff60ec26001522fa))
* prevent EISDIR crash on /static directory requests ([5b9c2db](https://github.com/carscanbe/emailengine/commit/5b9c2db2d3e8f46c55ef0dc7343b7fb730e52414))
* prevent EISDIR crash on static subdirectory requests in pkg ([4d5ef81](https://github.com/carscanbe/emailengine/commit/4d5ef81679e4fd7f5e8a55a260f2c29f99938ba4))
* prevent IMAP proxy worker crashes and connection leaks ([#596](https://github.com/carscanbe/emailengine/issues/596)) ([4453330](https://github.com/carscanbe/emailengine/commit/4453330ad38fb3e64692add1357d48227e1956e0))
* prevent IMAP worker crash on download stream errors ([d9d5396](https://github.com/carscanbe/emailengine/commit/d9d539632cc245a8e2a14585fc7918186bee00b6))
* prevent IMAP worker crash on ImapFlow unhandled rejection during IDLE recovery ([86ebb02](https://github.com/carscanbe/emailengine/commit/86ebb02c321ffa758966af1957509c10e20a35fc))
* prevent infinite loop and add retry backoff in account assignment ([f8b9e53](https://github.com/carscanbe/emailengine/commit/f8b9e533a821d1c34a869270fa489437ac80da93))
* prevent message event loss during IMAP sync under heavy load ([ceb139b](https://github.com/carscanbe/emailengine/commit/ceb139b825eaf7fc06bf1c88b9bcc89824abbcdb))
* prevent null dereference crash in getImapConnection during connection drops ([6a356fd](https://github.com/carscanbe/emailengine/commit/6a356fd20e1412a070c26c093108c4ea2a722a5c))
* prevent open redirects via next parameter and require password for passkey registration ([0e7f52a](https://github.com/carscanbe/emailengine/commit/0e7f52ada9687234682027ecb93e81515fcb9dbb))
* prevent oscillating recovery loop for Pub/Sub apps missing googleProjectId ([8bdbc39](https://github.com/carscanbe/emailengine/commit/8bdbc39c790b7097b02459b558328c18584585a2))
* prevent permanently lost accounts after worker crashes ([3deabb5](https://github.com/carscanbe/emailengine/commit/3deabb55b195601bf0c14d248257cc8a4aac76d2))
* prevent post-BYE command dispatch in IMAP proxy teardown ([d51e92d](https://github.com/carscanbe/emailengine/commit/d51e92d298e9373a6dc5c2eb0919885e161b45c7))
* prevent sync state corruption from invalid uidNext values ([533f026](https://github.com/carscanbe/emailengine/commit/533f026933fbbefb8b6998e412dc8cf3693c2b9b))
* prevent sync state corruption from invalid uidValidity values ([976fdb7](https://github.com/carscanbe/emailengine/commit/976fdb7a1a74127c6c738b331f2c5aa8b7daddb4))
* prevent transient network errors during OAuth2 token refresh from being misclassified as auth failures ([38fa212](https://github.com/carscanbe/emailengine/commit/38fa212092847b727ac1d02541103c032a983dc7))
* prevent unhandled promise rejections during mailbox sync ([e6174de](https://github.com/carscanbe/emailengine/commit/e6174defbf1c94f54ac7cbcb45eaa9e5c547926e))
* prevent UTF-8 data corruption in OAuth request Buffer handling ([14361fd](https://github.com/carscanbe/emailengine/commit/14361fdc4c7c04ad2ca5934eb4d418abf1c66289))
* re-arm a generous idle timeout for proxied IMAP connections ([627c6d4](https://github.com/carscanbe/emailengine/commit/627c6d472e50f6fc3e958e4774226557a526018d))
* Reduce production node_modules size by removing unused static-only deps ([af9d584](https://github.com/carscanbe/emailengine/commit/af9d584d4ad806e8a0b9eb7e59e6d5c8c8ff8878))
* reduce Pub/Sub recovery log noise and respect backoff delay ([63cd78f](https://github.com/carscanbe/emailengine/commit/63cd78fcfd0c12934e488f6936109653371f0899))
* reject in-flight worker calls when a worker thread terminates ([08e7b01](https://github.com/carscanbe/emailengine/commit/08e7b0128a4b8e9f9e5a96fefe49110bd032bd2c))
* reject invalid nonce format instead of silently regenerating ([422ea5c](https://github.com/carscanbe/emailengine/commit/422ea5c3dc56f4cf1679a1783d4c108d1486f455))
* reject OAuth2 grants with missing Google granular consent scopes ([3f277d1](https://github.com/carscanbe/emailengine/commit/3f277d1428e4a861752eb18b5d74279afefd1efa))
* relax cross-folder assertion in Graph API parentFolderId test ([770279d](https://github.com/carscanbe/emailengine/commit/770279ded669efdc5d6a2c33d05290daf91251ea))
* release cross-thread download streams on abort and error ([6514249](https://github.com/carscanbe/emailengine/commit/65142499d095bbcb5f0bb49755a2e24f6e52fa62))
* release MessagePort streams when message/attachment downloads fail ([787f4f5](https://github.com/carscanbe/emailengine/commit/787f4f5ef6364ec1389c15269c8f7f8eaaa2142a))
* remove BullMQ job when marking interrupted exports as failed ([ad587a7](https://github.com/carscanbe/emailengine/commit/ad587a7e0e536f2cb1647f420daa338e24d24233))
* remove dead circuit breaker code from IMAP and webhooks workers ([da9295b](https://github.com/carscanbe/emailengine/commit/da9295b951d20a5817116195689dd3c964b3d996))
* remove dead redirectToSlash option from static directory handler ([f90339a](https://github.com/carscanbe/emailengine/commit/f90339a663913f47a6d1878225633a4f7cb4ac7e))
* remove password hash from error logs and update passkey description copy ([d28dd16](https://github.com/carscanbe/emailengine/commit/d28dd16e61fc84d0800546c4f33d4535f52e2a22))
* remove Pub/Sub circuit breaker, fix 401/403 recovery handling ([b7017f3](https://github.com/carscanbe/emailengine/commit/b7017f34478dbb3bcedfb9a1e098a8a45cb0f83d))
* remove unnecessary min-height from login form ([f16940d](https://github.com/carscanbe/emailengine/commit/f16940d9957df114ce0ff4240107a82619a58705))
* Rename IMAP worker to Email worker in thread display ([95b39da](https://github.com/carscanbe/emailengine/commit/95b39da07c7ee28ac0539f6599546bc49af8e0ac))
* reorder OAuth app deletion to prevent pull-loop gap, add startLoop tests ([129f96c](https://github.com/carscanbe/emailengine/commit/129f96c99ff9ff2552fa1c1962b1e0a652b8837e))
* replace BigInt literal with constructor for gettext parser compatibility ([119ba69](https://github.com/carscanbe/emailengine/commit/119ba6919768ff6d22161e6c7884b8020fab37f5))
* replace blocking scryptSync with async scrypt in DecryptStream ([c9c6ede](https://github.com/carscanbe/emailengine/commit/c9c6edefb11bf7908e5fd64118ff4211f5f6bd4e))
* replace custom Redis locks with ioredfour in Outlook subscription code ([019eaa1](https://github.com/carscanbe/emailengine/commit/019eaa1f26be504d127cb6c8a05dfe50d8a47b71))
* replace spread syntax with Object.assign in tools.js for gettext parser compatibility ([02ecc60](https://github.com/carscanbe/emailengine/commit/02ecc60071c2a798eb6aae32ee6cdfe5a43933b2))
* report correct nextAttempt time for queued messages ([d5ebdfb](https://github.com/carscanbe/emailengine/commit/d5ebdfb029b3ed331a8239ace7426f4f0704ae2e))
* resolve 11 bugs in export functionality ([f5d2621](https://github.com/carscanbe/emailengine/commit/f5d2621bbaa2cf3b1dab06c67a7e2d5bf29075ed))
* resolve code review findings in Gmail bulk ops, exports, webhooks, and schemas ([f0ddb46](https://github.com/carscanbe/emailengine/commit/f0ddb4631fb924ddb93e0a99d0e20bc9f0cc8ee2))
* resolve ESLint 10 lint errors ([7d397f6](https://github.com/carscanbe/emailengine/commit/7d397f6d87c87c4a8bb456a52c9db264c7c14243))
* resolve Gmail label IDs to human-readable names ([02c306f](https://github.com/carscanbe/emailengine/commit/02c306f10f29d8941f242f9283684621fefcd5c3))
* resolve HTTP proxy feature issues ([750619d](https://github.com/carscanbe/emailengine/commit/750619d0145b60706dedec1d39ae94f9a2457ab7))
* resolve lint errors, fix TTL null guard, and extract Pub/Sub constants ([4949431](https://github.com/carscanbe/emailengine/commit/4949431c8e05f06c5aafc3dfe93876ea8a2875b9))
* resolve livelock, timeout, and state corruption in MS Graph subscription lifecycle ([745334e](https://github.com/carscanbe/emailengine/commit/745334e8c55fcf4b0b3fc6adef2b37f6cf9aea61))
* resolve OAuth2 provider for delegated Outlook accounts ([f35c816](https://github.com/carscanbe/emailengine/commit/f35c816e3149eeaa568d86c06fa6783c649c54c5))
* resolve OpenAPI spec validation errors for token restrictions ([a9cffe1](https://github.com/carscanbe/emailengine/commit/a9cffe150843fb7f8b4f7f5d01afc69ef451bac2))
* restore IMAP XOAUTH2 path for gmailService accounts ([d2ebe9b](https://github.com/carscanbe/emailengine/commit/d2ebe9b3c19cd0bcaaf0fa17d40148f79dd7cd2b))
* restore retry for empty Buffer payloads and fix large threaded Gmail replies ([107c164](https://github.com/carscanbe/emailengine/commit/107c16475a2278a9428903d7280f481cf62a64ec))
* retry transient errors during Pub/Sub resource deletion and log dropped messages ([b9d9de5](https://github.com/carscanbe/emailengine/commit/b9d9de56a50b37e0163ea4e9a954d65bc305004c))
* retry transient errors in API-account batch export path ([6cba7c7](https://github.com/carscanbe/emailengine/commit/6cba7c72658a037f68867cf2464f7d3420a79507))
* retry transient network errors in Gmail and Outlook API request functions ([08ea0da](https://github.com/carscanbe/emailengine/commit/08ea0daecaec73c58a91ac07df5d0f0ffc083a2f))
* return 422 for unsupported label search and surface Outlook categories ([d981359](https://github.com/carscanbe/emailengine/commit/d981359b78b61d2c8a03e4e35086a4c9674ce53a))
* return the append destination folder from uploadMessage ([96aed6b](https://github.com/carscanbe/emailengine/commit/96aed6b1144e1d3ee9da79b3a1fb03606245f83c))
* return WorkerNotAvailable immediately and remove batch submit endpoint ([aed5c45](https://github.com/carscanbe/emailengine/commit/aed5c45aeec37a42b6c7113a3e45cb7153ae67bb))
* revert jQuery to 3.7.1 and harden export resilience ([43f2a74](https://github.com/carscanbe/emailengine/commit/43f2a74587fc8915dbb6dce6497f60a8159f6140))
* right-align the service account Add account button ([c6f77b9](https://github.com/carscanbe/emailengine/commit/c6f77b9777fb1cb9b1449662d05d4887e36a6ad8))
* send Buffer for Outlook sendMail base64 payload to avoid JSON quoting ([e89a924](https://github.com/carscanbe/emailengine/commit/e89a924343bf8ba3ea1fd7e75bc09aa53c2177b2))
* send correctly typed SMTP and IMAP proxy state change notifications ([3fbd27f](https://github.com/carscanbe/emailengine/commit/3fbd27fc08bb74f9738a3fc95d4177fa4978c263))
* share Lock instance across Account objects to prevent Redis connection leak ([56f421b](https://github.com/carscanbe/emailengine/commit/56f421b866a12187937cfa935764878f14f0ab1b))
* show Failed status for accounts with IMAP disabled due to auth errors ([e6b687d](https://github.com/carscanbe/emailengine/commit/e6b687d458cfd080795f7176f862109e2c299fff))
* show OAuth apps with failed Pub/Sub setup in subscriptions list ([14124cd](https://github.com/carscanbe/emailengine/commit/14124cd29baf107f1f82dff48695bc51cae4fd97))
* stabilize Swagger model names for SDK generation ([8078830](https://github.com/carscanbe/emailengine/commit/80788305f23eee9d021b4c72dce21961493ca093))
* stop Pub/Sub instances on OAuth2 app deletion and harden lifecycle ([bc0ff75](https://github.com/carscanbe/emailengine/commit/bc0ff758cea8d8713485e3a28e81b16ee56d1dc7))
* stop referencing prepared password string in error log ([50cdb89](https://github.com/carscanbe/emailengine/commit/50cdb8998e27f33f700f267cb39ddba39e7d32d0))
* surface TTL reconciliation failures to operators via ttlWarning meta flag ([6e5d5c5](https://github.com/carscanbe/emailengine/commit/6e5d5c5a97fb9aaff2662f3fe2f90c8226359b4a))
* switch pkg targets from node22 to node24 to fix Windows builds ([12522a7](https://github.com/carscanbe/emailengine/commit/12522a7b92d72684af49cd70c1c6d4bcafe1d4af))
* tear down subconnections when deleting an IMAP account ([bd81a33](https://github.com/carscanbe/emailengine/commit/bd81a33caf9400cbee2781a9180f1a901c1d6e48))
* throw instead of silent return in select() null guard, revert redundant optional chaining ([cb7db50](https://github.com/carscanbe/emailengine/commit/cb7db5024e0b00f8a773328dd5e0009067bed0b6))
* tighten export route validation and apply default export limits ([f45d83f](https://github.com/carscanbe/emailengine/commit/f45d83f1d27ab05984f1a0213174025f5f79d71e))
* translate OAuth scope error page across 6 languages ([4ae1919](https://github.com/carscanbe/emailengine/commit/4ae19199fe628f8a4f7177d53db1f05167077e3e))
* treat DNS errors as transient in Google Pub/Sub polling loop ([ec33673](https://github.com/carscanbe/emailengine/commit/ec33673b47242fd7156b4641c9c4924a33eaf9e5))
* update client-side Handlebars to 4.7.9 and harden passkey input validation ([882891c](https://github.com/carscanbe/emailengine/commit/882891c36ed3704d96ccf227e682e152f5395036))
* update gettext script to include refactored UI route files ([5b2e4a5](https://github.com/carscanbe/emailengine/commit/5b2e4a55771f192fb14d030b5e5d08ba860c90ab))
* update imapflow to 1.2.15 to fix unhandled rejection crashes ([494a3f8](https://github.com/carscanbe/emailengine/commit/494a3f8cd9e71bc1fc1683bea2fc92474cb33206))
* update test expectations for email-text-tools 2.3.5+ behavior ([1e28abf](https://github.com/carscanbe/emailengine/commit/1e28abf77282ac4c550f9834f61064ae8fde7de9))
* update test expectations for email-text-tools 2.4.x ([6333fa3](https://github.com/carscanbe/emailengine/commit/6333fa3308b1b822a5c364ad5cb25c1c211edeca))
* update tests for getCurrentListing null guard changes ([a644f9c](https://github.com/carscanbe/emailengine/commit/a644f9c1c3f3e4cbce388e43bfa319f11f4a469c))
* upgrade handlebars to 4.7.9 to resolve prototype pollution vulnerability ([452f5f5](https://github.com/carscanbe/emailengine/commit/452f5f54f4007e4b765e18861ce01cde312cc83c))
* upgrade joi to 17.13.4 and @postalsys/certs to 1.0.15 (GHSA-q7cg-457f-vx79) ([6ec77e5](https://github.com/carscanbe/emailengine/commit/6ec77e50b288b14550cd09b724f5aab59d17ced4))
* use base64url encoding for OAuth state nonce in /v1/authentication/form ([1f2cecf](https://github.com/carscanbe/emailengine/commit/1f2cecf9efbee8a12c3a0d27c9879bfbbf7dfa39))
* use base64url encoding for OAuth state nonce in /v1/authentication/form ([dead38c](https://github.com/carscanbe/emailengine/commit/dead38c348f1c0204f2bfba09997090cb86c348b))
* use base64url encoding for OAuth state nonce in remaining locations ([961b710](https://github.com/carscanbe/emailengine/commit/961b710357d836782c9bbce329178aa96e08ee20))
* use consistent index source in batch submit success and failure paths ([3a73704](https://github.com/carscanbe/emailengine/commit/3a737047c1f1e4fda6bd7c4b6822ca31ebe27fd2))
* use STATUS instead of NOOP as keepalive for 163.com IMAP ([3b3516f](https://github.com/carscanbe/emailengine/commit/3b3516feb14e64bab5ac586378237f2160cdf010))
* use template literals for translated strings in showErrorPopup ([b56fd1f](https://github.com/carscanbe/emailengine/commit/b56fd1fa7612b4cf2b7e99cbd78d7447b89c03c6))
* validate fallback status codes in resolveOAuthErrorStatus ([d2b49e3](https://github.com/carscanbe/emailengine/commit/d2b49e3ad0c78c17a8aee6f1679fa3597d85ca4b))
* validate nonce format before using data.n from cached URLs ([d825303](https://github.com/carscanbe/emailengine/commit/d82530395e93e88f5841156a53fe41d476eec9da))
* Wrap async close handler await calls in try-catch to prevent unhandled rejections ([c6df321](https://github.com/carscanbe/emailengine/commit/c6df321c7a580c1cd10d2e1eac5681aa49e4c87a))


### Performance Improvements

* optimize mailbox listing for accounts with many folders ([a39e5f7](https://github.com/carscanbe/emailengine/commit/a39e5f7b02156fc73ab44d1ca4f6e977e4290312))
* use MS Graph batch API for Outlook message export ([f031f77](https://github.com/carscanbe/emailengine/commit/f031f770278a14aeb2fd5a589e31bb5621b0c410))


### Reverts

* remove Swagger UI light mode forcing ([9c9bd25](https://github.com/carscanbe/emailengine/commit/9c9bd25e4488828e3112e671df12d1c551957dac))
